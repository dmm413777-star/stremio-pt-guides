...
{{< callout type="info" >}}
O **Gemini** permite pesquisa por IA no Stremio. Exemplo: *"filmes parecidos com Interstellar mas passados no fundo do mar"*.
{{< /callout >}}
...
- [Toast Translator](/guias/toast-translator): títulos e sinopses em português
